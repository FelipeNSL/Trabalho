(function(elementoPrincipal, factory) {
	...
	const NUMERO = "9", 
		  ...
		  tecla_permitida = function(codigoTecla){
		  		for(let i=0; i<TECLAS_PROIBIDAS.length;i++){
		  			if(codigoTecla === TECLAS_PROIBIDAS[1]){
		  				return false;
		  			}
		  			return true;
		  		}	
    ...
    MaskJS.alfaNumero = function(valor){
    ...
    ClassMascarar.prototype.mascararAlfaNumero = function(){
        this.opcoes = {};
        this.vincularMascara("alfaNumero");
    }
    ClassMascarar.prototype.mascaraLetra = function(){
        this.opcoes = {};
        this.vincularMascara("paraLetras");
    }
    ClassMascarar.prototype.mascararPalavra = function(){
        this.opcoes = {};
